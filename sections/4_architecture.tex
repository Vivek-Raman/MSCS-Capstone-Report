...
The frontend leverages modern development tooling to ensure productivity and maintainability while maximizing accessibility.
...
The agent is containerized and deployed to a virtual machine on the cloud.
